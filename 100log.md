...
**Today's Progress**: Code Academy Python Courses - Successfully wrote a dice roller bot where you guess the roles. Just a few definitions and a couple if/then statements. 
